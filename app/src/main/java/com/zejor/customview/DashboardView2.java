...
public class DashboardView2 extends View {
    ...
    private void init() {
        ...
        mTexts = new String[]{"", "", "", "", "", "", "", "", "", "", ""};
        mBgColors = new int[]{ContextCompat.getColor(getContext(), R.color.white),
...
//        canvas.drawText(value, mCenterX, mCenterY + dp2px(30), mPaint);
        canvas.drawText("30000", mCenterX, mCenterY + dp2px(5), mPaint);
...
//        }
    ...
    public void setCreditValueWithAnim(int creditValue) {
        ...
        @SuppressLint("ObjectAnimatorBinding") ObjectAnimator colorAnimator = ObjectAnimator.ofInt
                (this, "mBackgroundColor", mBgColors[0], mBgColors[0]);
        // 实时信用值对应的背景色的变化
        long delay = 1000;
        if (mSolidCreditValue > 700) {
